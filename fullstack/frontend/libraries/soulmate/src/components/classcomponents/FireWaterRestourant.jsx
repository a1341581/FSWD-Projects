...
class FireWaterRestourant extends Component{
constructor(){
    super()
...
render(){
    ...
    return (
        ...
        <br/>
        <h1>
            { this.state.io===true?<Gokul/>:<h1>Customer outside of restourant</h1>  }
        </h1>
        <button onClick={()=>{this.setState({io:!this.state.io})}}>click me pay with customer</button>
        </>
    )
}
...
export default FireWaterRestourant